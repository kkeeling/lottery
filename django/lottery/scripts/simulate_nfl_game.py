    ...
    for game in [slate.games.all()[4]]:
        try:
            ...
            for _ in range(0, 10000):
                x = [
                    max(0.0, np.random.gamma((float(home_qb.projection)/float(home_qb.stdev))**2, (float(home_qb.stdev)**2)/float(home_qb.projection))),
                    max(0.0, np.random.gamma((float(home_rb1.projection)/float(home_rb1.stdev))**2, (float(home_rb1.stdev)**2)/float(home_rb1.projection))),
                    max(0.0, np.random.gamma((float(home_rb2.projection)/float(home_rb2.stdev))**2, (float(home_rb2.stdev)**2)/float(home_rb2.projection))),
                    max(0.0, np.random.gamma((float(home_wr1.projection)/float(home_wr1.stdev))**2, (float(home_wr1.stdev)**2)/float(home_wr1.projection))),
                    max(0.0, np.random.gamma((float(home_wr2.projection)/float(home_wr2.stdev))**2, (float(home_wr2.stdev)**2)/float(home_wr2.projection))),
                    max(0.0, np.random.gamma((float(home_wr3.projection)/float(home_wr3.stdev))**2, (float(home_wr3.stdev)**2)/float(home_wr3.projection))),
                    max(0.0, np.random.gamma((float(home_te.projection)/float(home_te.stdev))**2, (float(home_te.stdev)**2)/float(home_te.projection))),
                    max(0.0, np.random.gamma((float(home_dst.projection)/float(home_dst.stdev))**2, (float(home_dst.stdev)**2)/float(home_dst.projection))),
                    max(0.0, np.random.gamma((float(away_qb.projection)/float(away_qb.stdev))**2, (float(away_qb.stdev)**2)/float(away_qb.projection))),
                    max(0.0, np.random.gamma((float(away_rb1.projection)/float(away_rb1.stdev))**2, (float(away_rb1.stdev)**2)/float(away_rb1.projection))),
                    max(0.0, np.random.gamma((float(away_rb2.projection)/float(away_rb2.stdev))**2, (float(away_rb2.stdev)**2)/float(away_rb2.projection))),
                    max(0.0, np.random.gamma((float(away_wr1.projection)/float(away_wr1.stdev))**2, (float(away_wr1.stdev)**2)/float(away_wr1.projection))),
                    max(0.0, np.random.gamma((float(away_wr2.projection)/float(away_wr2.stdev))**2, (float(away_wr2.stdev)**2)/float(away_wr2.projection))),
                    max(0.0, np.random.gamma((float(away_wr3.projection)/float(away_wr3.stdev))**2, (float(away_wr3.stdev)**2)/float(away_wr3.projection))),
                    max(0.0, np.random.gamma((float(away_te.projection)/float(away_te.stdev))**2, (float(away_te.stdev)**2)/float(away_te.projection))),
                    max(0.0, np.random.gamma((float(away_dst.projection)/float(away_dst.stdev))**2, (float(away_dst.stdev)**2)/float(away_dst.projection))),
                ]
