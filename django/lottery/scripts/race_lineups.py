...
def run():
    ...
    # print(p6)
    start = time.time()
    scores = numpy.array(p1['sim_scores_0'].to_list()) + numpy.array(p1['sim_scores_1'].to_list()) + numpy.array(p1['sim_scores_2'].to_list()) + numpy.array(p1['sim_scores_3'].to_list()) + numpy.array(p1['sim_scores_4'].to_list()) + numpy.array(p1['sim_scores_5'].to_list())
    print(scores)
