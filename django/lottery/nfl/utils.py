...
# Returns variance of a given projection based on historical outcomes from similar players/projections
...
# Calculate nearest correlation PSD matrix to A (non-PSD)
